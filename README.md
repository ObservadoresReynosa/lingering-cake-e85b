...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-cake-e85b
```

A live public deployment of this template is available at [https://lingering-cake-e85b.templates.workers.dev](https://lingering-cake-e85b.templates.workers.dev)
